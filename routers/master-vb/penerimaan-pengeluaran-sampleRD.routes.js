...
const { getStockDataByRak, getRakNotEmpty, browseItem, cmdSimpanMasuk, cmdDeleteMasuk, getStockByDate, exportStockDataToExcel, btnSaveKeluar, cekForumulaExisting, cmdApproveKeluar, cmdAddNewKeluar, btnDeleteDetail, btnPrint, getHistoryData, cmdApproveMasuk, findHistoryByKodeBahan, loadGridMaster, loadGriddetil, searchByKodeBahan, handleItemPrint, searchNoPermintaan } = require("../../controllers/master-vb/trx-penerimaan-pengeluaran-sampleRD.controller");
