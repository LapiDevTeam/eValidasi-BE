...
const SESSION_COLUMNS = `
  ...
  status, pic, conclusion, evaluation_result,
...
async function listSessions(filters = {}) {
  ...
  let query = `
    SELECT
      ...
      s.qa_id, s.id_no_sertifikat,
      s.approved_by_admin, s.approved_by_admin_date,
      s.approved_by_officer, s.approved_by_officer_date,
      s.approved_by_manager, s.approved_by_manager_date,
      s.rejected_by, s.rejected_reason, s.rejected_at,
