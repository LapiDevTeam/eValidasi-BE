...
module.exports = (sequelize, DataTypes) => {
  class t_catatanTrial_status extends Model {
    /**
    ...
    static associate(models) {
      ...
      t_catatanTrial_status.belongsTo(models.t_catatanTrial, {
        foreignKey: "CatatanTrialID",
      });
    }
  }
  t_catatanTrial_status.init(
    {
    ...
    {
      sequelize,
      modelName: "t_catatanTrial_status",
      freezeTableName: true,
    }
  );
  return t_catatanTrial_status;
};
