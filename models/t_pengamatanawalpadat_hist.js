...
module.exports = (sequelize, DataTypes) => {
  class t_pengamatanAwalPadat_hist extends Model {
    /**
  ...
  t_pengamatanAwalPadat_hist.init(
    {
    ...
    {
      sequelize,
      modelName: "t_pengamatanAwalPadat_hist",
      freezeTableName: true,
    }
  );
  return t_pengamatanAwalPadat_hist;
};
