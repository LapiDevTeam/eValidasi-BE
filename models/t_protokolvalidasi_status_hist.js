...
module.exports = (sequelize, DataTypes) => {
  class t_protokolValidasi_status_hist extends Model {
    /**
  ...
  t_protokolValidasi_status_hist.init(
    {
    ...
    {
      sequelize,
      modelName: "t_protokolValidasi_status_hist",
      freezeTableName: true,
    }
  );
  return t_protokolValidasi_status_hist;
};
