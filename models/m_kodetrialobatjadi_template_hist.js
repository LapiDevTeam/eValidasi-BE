...
module.exports = (sequelize, DataTypes) => {
  class m_kodeTrialObatJadi_template_hist extends Model {
    /**
  ...
  m_kodeTrialObatJadi_template_hist.init(
    {
    ...
    {
      sequelize,
      modelName: "m_kodeTrialObatJadi_template_hist",
      freezeTableName: true,
    }
  );
  return m_kodeTrialObatJadi_template_hist;
};
