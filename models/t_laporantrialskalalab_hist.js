...
module.exports = (sequelize, DataTypes) => {
  class t_laporanTrialSkalaLab_hist extends Model {
    /**
  ...
  t_laporanTrialSkalaLab_hist.init(
    {
    ...
    {
      sequelize,
      modelName: "t_laporanTrialSkalaLab_hist",
      freezeTableName: true,
    }
  );
  return t_laporanTrialSkalaLab_hist;
};
