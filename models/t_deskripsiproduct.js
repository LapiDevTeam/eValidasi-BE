...
module.exports = (sequelize, DataTypes) => {
  class t_deskripsiProduct extends Model {
    /**
    ...
    static associate(models) {
      ...
      t_deskripsiProduct.belongsTo(models.t_studiPraformulasi, {
        foreignKey: "StudiPraformulasiID",
      });
    }
  }
  t_deskripsiProduct.init(
    {
    ...
    {
      sequelize,
      modelName: "t_deskripsiProduct",
      freezeTableName: true,
    }
  );
  return t_deskripsiProduct;
};
