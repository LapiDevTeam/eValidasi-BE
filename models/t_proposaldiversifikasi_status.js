...
module.exports = (sequelize, DataTypes) => {
  class t_proposalDiversifikasi_status extends Model {
    /**
    ...
    static associate(models) {
      ...
      t_proposalDiversifikasi_status.belongsTo(models.t_proposalDiversifikasi, {
        foreignKey: "ProposalDiversifikasiID",
      });
    }
  }
  t_proposalDiversifikasi_status.init(
    {
    ...
    {
      sequelize,
      modelName: "t_proposalDiversifikasi_status",
      freezeTableName: true,
    }
  );
  return t_proposalDiversifikasi_status;
};
