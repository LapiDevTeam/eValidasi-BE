...
module.exports = (sequelize, DataTypes) => {
  class t_proposalDiversifikasi_hist extends Model {
    /**
  ...
  t_proposalDiversifikasi_hist.init(
    {
    ...
    {
      sequelize,
      modelName: "t_proposalDiversifikasi_hist",
      freezeTableName: true,
    }
  );
  return t_proposalDiversifikasi_hist;
};
