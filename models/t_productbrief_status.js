...
module.exports = (sequelize, DataTypes) => {
  class t_productBrief_status extends Model {
    /**
    ...
    static associate(models) {
      ...
      t_productBrief_status.belongsTo(models.t_productBrief, {
        foreignKey: "ProductBriefId",
      });
    }
  }
  t_productBrief_status.init(
    {
    ...
    {
      sequelize,
      modelName: "t_productBrief_status",
      freezeTableName: true,
    }
  );
  return t_productBrief_status;
};
